...
from vllm.platforms.tpu import USE_TPU_COMMONS, USE_TPU_INFERENCE
...
if not USE_TPU_COMMONS or not USE_TPU_INFERENCE:
    logger.info("tpu_commons/tpu_inference not found, using vLLM's TPUWorker.")
